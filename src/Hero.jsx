...
export default function Hero() {
  ...
  <div className="text-center flex flex-col lg:gap-0 gap-5">
    ...
    <p className="lg:text-2xl text-xl lg:w-[80%] mx-auto font-light">We turn your empty house to a lovely home, making the compact spaces with sapce saving furnitures. Making the unique tastes of yours into reality!</p>
   </div>
